                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                    ...
                                    @foreach ($services as $key => $service)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.services.destroy', ['service' => $service]) }}" method="post" class="d-inline" id="deleteForm-{{ $service->id }}">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                @else
                                    <tr>
                                        <td colspan="4">{{ __('keywords.no_records_found') }}</td>
                                    </tr>
                                @endif
